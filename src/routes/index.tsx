/**
 * Home dashboard — today's stats banner and a grid of all decks.
 *
 * Empty state (zero decks) offers two CTAs: create a deck from scratch or
 * load the demo dataset (Rust-side stub today, will be filled by C1).
 */
